define([
    ...
    angular.module('myApp.order_service',['myApp.md5_service'])
	.factory('order_service',['$http','md5_service', function($http,md5_service){
        ...
        //等待MD5加密
        var oauth=md5_service.md5(appkey+times+appTolen);
        ...
        return {
            ...
            getOptions: function (pk) {
                var time = Date.parse(new Date()).toString().substr(0, 10);
                var oauth = md5_service.md5(appkey + time + appTolen);
